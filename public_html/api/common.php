...
function getMockPins() {
    return [
        ...
        [
            ...
            'type' => 'radar',
            'status' => 'active',
            'name' => 'Radarkontroll Svenskegrensa',
            'lat' => 59.1372,
        ...
        [
            ...
            'type' => 'radar',
            'status' => 'active',
            'name' => 'Radarkontroll E18 Corridor',
            'lat' => 59.2833,
